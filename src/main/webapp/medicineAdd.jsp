...
<c:choose>
    ...
    <div id="medicineModal" class="modal">
        ...
        <c:remove var="errorMessage" scope="session"/>
                    ...
                    <textarea name="medDescription" placeholder="Enter Description" required></textarea>

                    <label for="medQuantity">Quantity</label>
                    <input type="number" name="medQuantity" placeholder="Enter Quantity"/>

                    <label for="medPrice">Price</label>
                    <input type="number" name="medPrice" placeholder="Enter Price"/>
                    
                    <div class="modal-footer">
                        <button type="button" class="cancel-btn" onclick="window.location.href='insertDash.jsp'">Cancel</button>
                        <button class="add-btn" type="submit">Add Medicine</button>
                    </div>
                </form> 
            </div>
        </div>
